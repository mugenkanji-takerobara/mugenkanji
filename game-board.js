...
(() => {
  ...
  app.ボーナス確定 = function () {
    const 状態 = app.状態;
    if (!状態.確認待ち) return;
    if (状態.確認待ち.種類 === "岳") app.岳消去確定();
    if (状態.確認待ち.種類 === "代") app.代入替確定();
  };
